  ...
  function registerCheck(){
	  ...
	  $.ajax({
		  ...
		  success : function(result){
			  //중복유무 출력(result=1 : 사용할수있는 아이디, result=0 : 사용할수 없는 아이디)
			  if(result==1){
    ...
    <form name="frm" method="post" action="${contextPath}/memRegister.do">
    	...
    	<table class="table table-bordered" style="text-align:center; border: 1px solid #dddddd;">
    		<tr>
				...
				<td><input id="memID" name="memID"  class="form-control" type="text" maxlength="20" placeholder="아이디를 입력해주세요."/></td>    
    		...
    		<tr>
    			<td colspan="3" style="text-align: left;">
    				<span id="passMessage" style="color:red"></span><input type="button" class="btn btn-primary btn-sm pull-right" value="등록" onclikc="goInsert()"/>
    			</td>
    		</tr>
    	</table>
    </form>
