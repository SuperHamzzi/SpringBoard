...
<head>
  ...
  <script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script> <!-- 검색 자동출력 -->
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9d17347e69646b59500edead74b5f00c"></script>
  <script type="text/javascript">
     $(document).ready(function(){
    	...
    	//input box에 책 제목이 입력되면 자동으로 검색하는 기능
    	$("#bookname").autocomplete({ // autocomplete 데이터가 입력되면
    		source : function(){
    			var bookname= $("#bookname").val();
    			$.ajax({
    				url : "https://dapi.kakao.com/v3/search/book?target=title",
    		...
    		minLength : 1 //글자 1개가 입력해야 source가 동작함
    	}); 
    	...
    	$("#mapBtn").click(function(){
    		...
    		$.ajax({
    			...
    			headers : {"Authorization": "KakaoAK 242a78656f2c16e18564c2b1a2d941c8"},
    			type : "get",
    			data : {"query" : address},
    			dataType : "json",
    			success : mapView,
